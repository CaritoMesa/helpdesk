 ...
 * @method \App\Model\Entity\TipoTicket newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\TipoTicket[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\TipoTicket|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\TipoTicket patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\TipoTicket[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\TipoTicket findOrCreate($search, callable $callback = null, $options = [])
 */
class TipoTicketsTable extends Table
{

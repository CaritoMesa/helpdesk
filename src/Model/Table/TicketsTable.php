 ...
 * Tickets Model
 *
 * @property \Cake\ORM\Association\BelongsTo $TicketCategorias
 * @property \Cake\ORM\Association\BelongsTo $TipoTickets
 * @property \Cake\ORM\Association\BelongsTo $TicketEstados
...
class TicketsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('TicketCategorias', [
            'foreignKey' => 'categoria_id',
            'joinType' => 'INNER'
        ]);
        $this->belongsTo('TipoTickets', [
            'foreignKey' => 'tipo_id',
            'joinType' => 'INNER'
        ]);
        $this->belongsTo('TicketEstados', [
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->allowEmpty('contacto_adicional');

        $validator
            ->date('fecha_cerrado')
            ->allowEmpty('fecha_cerrado');
    ...
    {
        $rules->add($rules->existsIn(['categoria_id'], 'TicketCategorias'));
        $rules->add($rules->existsIn(['tipo_id'], 'TipoTickets'));
        $rules->add($rules->existsIn(['estado_id'], 'TicketEstados'));
        $rules->add($rules->existsIn(['solicitante_id'], 'Usuarios'));
        $rules->add($rules->existsIn(['tecnico_id'], 'Usuarios'));
